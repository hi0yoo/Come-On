...
include::{snippets}/common-response-rest-docs-test/slice-response/http-response.adoc[]

==== 응답 필드

include::{snippets}/common-response-rest-docs-test/slice-response/response-fields-data.adoc[]

=== 공통 응답 스펙 - List 응답의 경우

==== 응답 예시
include::{snippets}/common-response-rest-docs-test/list-response/http-response.adoc[]

==== 응답 필드
include::{snippets}/common-response-rest-docs-test/list-response/response-fields-data.adoc[]
...
include::{snippets}/common-response-rest-docs-test/place-category-list/common-response-fields-place-category.adoc[]
...
로그인하지 않은 경우에도 정상적으로 응답합니다.
로그인하지 않았기 때문에 ``data.contents.userLiked`` 필드는 항상 ``false``입니다.

include::{snippets}/course-list/success-un-authorized/http-response.adoc[]

==== 응답 필드

거리 필드의 단위는 ``km``(킬로미터) 입니다.

include::{snippets}/course-list/success-un-authorized/response-fields-contents.adoc[]
...
[[My-Course-List-Normal]]
=== 1) 정상 흐름

==== 요청 예시

include::{snippets}/my-course-list/success/http-request.adoc[]

==== 요청 헤더

include::{snippets}/my-course-list/success/request-headers.adoc[]

==== 요청 파라미터

include::{snippets}/my-course-list/success/request-parameters.adoc[]
...
include::{snippets}/my-course-list/success/http-response.adoc[]

==== 응답 필드

거리 필드의 단위는 ``km``(킬로미터) 입니다.

include::{snippets}/my-course-list/success/response-fields-contents.adoc[]


[[My-Course-List-Error]]
=== 2) 예외

==== 응답 예시

로그인 되지 않은 사용자이거나, 올바르지 않은 인증 헤더로 요청하면,
다음과 같은 오류 응답을 반환합니다.

include::{snippets}/my-course-list/fail-un-authorized/http-response.adoc[]

==== 응답 필드

include::{snippets}/my-course-list/fail-un-authorized/response-fields-data.adoc[]
...
include::{snippets}/course-like-list/success/http-request.adoc[]

==== 요청 헤더

include::{snippets}/course-like-list/success/request-headers.adoc[]

==== 요청 파라미터

include::{snippets}/course-like-list/success/request-parameters.adoc[]
...
include::{snippets}/course-like-list/success/http-response.adoc[]

==== 응답 필드

거리 필드의 단위는 ``km``(킬로미터) 입니다.

include::{snippets}/course-like-list/success/response-fields-contents.adoc[]


[[Course-Like-List-Error]]
=== 2) 예외
...
include::{snippets}/course-like-list/fail-un-authorized/http-response.adoc[]

==== 응답 필드

include::{snippets}/course-like-list/fail-un-authorized/response-fields-data.adoc[]
...
==== 유저가 해당 코스에 좋아요를 등록하지 않은 경우 : 좋아요 등록

==== 요청 예시

include::{snippets}/course-like-modify/success-created/http-request.adoc[]

==== 요청 경로 파라미터

include::{snippets}/course-like-modify/success-created/path-parameters.adoc[]

==== 요청 헤더

include::{snippets}/course-like-modify/success-created/request-headers.adoc[]


==== 응답 예시
요청을 성공적으로 처리하면 다음과 같은 응답을 반환합니다.

include::{snippets}/course-like-modify/success-created/http-response.adoc[]

==== 응답 필드

include::{snippets}/course-like-modify/success-created/response-fields-data.adoc[]


==== 유저가 해당 코스에 좋아요를 등록했었던 경우 : 좋아요 취소

==== 응답 예시

include::{snippets}/course-like-modify/success-deleted/http-response.adoc[]


[[Course-Like-Error]]
=== 2) 예외

==== 존재하지 않는 코스의 식별값으로 요청한 경우
==== 응답 예시

존재하지 않는 코스의 식별값을 경로 파라미터에 담아서 요청하면 다음과 같은 오류를 반환합니다.

include::{snippets}/course-like-modify/invalid-course-id/http-response.adoc[]

==== 응답 필드

include::{snippets}/course-like-modify/invalid-course-id/response-fields-data.adoc[]


==== 로그인하지 않은 사용자가 요청, 또는 인증 오류가 발생한 경우
==== 응답 예시

로그인하지 않은 사용자가 요청하고나, 인증 과정에서 오류가 발생한 경우,
다음과 같은 응답을 반환합니다.

include::{snippets}/course-like-modify/un-authorized/http-response.adoc[]

==== 응답 필드

include::{snippets}/course-like-modify/un-authorized/response-fields-data.adoc[]
