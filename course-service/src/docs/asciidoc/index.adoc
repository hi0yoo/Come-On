...
[[Course-Details-Not-Complete-Success]]
=== 2) 작성이 완료되지 않은 코스의 경우 : 정상 흐름
...
[[Course-Details-Invalid-CourseId-Error]]
=== 4) 등록되지 않은 코스를 조회할 경우 : 예외
