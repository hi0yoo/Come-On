...
@Slf4j
public class MeetingUserCheckInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        log.info("[MeetingUserCheckInterceptor] 발동");
        ...
        // 요청을 보낸 회원이 모임에 가입되었는지 확인
        checkUserInclude(request, meetingUsers);
    ...
    private void checkUserInclude(HttpServletRequest request, List<MeetingUserEntity> meetingUsers) {
