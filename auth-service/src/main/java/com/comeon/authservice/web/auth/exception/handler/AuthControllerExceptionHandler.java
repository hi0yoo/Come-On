...
public class AuthControllerExceptionHandler {
    ...
    public ApiResponse<ErrorResponse> noSuchElementExceptionHandle(NoSuchElementException e) {
        return ApiResponse.createUnauthorized("유효하지 않은 토큰 코드", "유효하지 않은 Refresh Token 입니다.");
    }
